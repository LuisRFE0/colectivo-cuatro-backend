package com.colectivocuatro.app.security.jwt;
...
import com.colectivocuatro.app.security.UserDetailsImpl;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	// STEP 7.1 recuperar el email y password del body de la solicitud que vendría
	// en localhost:8080/login
	@Override
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		// asumimos que en el body de la petición viene en el formato JSON como { email,
		// password}
		try {
